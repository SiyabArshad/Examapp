  ...
  return (
    <SafeAreaView  style={styles.sv}>
      ...
      <Text style={styles.sfct01}>[Simulador]</Text>
        <Text style={styles.sfct1}>Exames de acesso às</Text>
        <Text style={styles.sfct3}>Licenças Federativas</Text>
        <Text style={styles.sfct2}>TAC • A/D • B • C • E</Text>
      </View>
      <View style={styles.firstch2}>
      <Radiobutton navigation={navigation}/>
      </View>
      <Text style={styles.sfct12} onPress={()=>Linking.openURL("https://examefederativo.pt/terms.html")}>Disclaimer</Text>
    </SafeAreaView>
  )
}
